...
// Token-style exports (what your pages already call)
...
// ----------------------------
// Try helpers (survive backend route changes)
// ----------------------------
...
// legacy alias name some pages used previously (different identifier, no duplicate export)
export const getPublicEventDiagramLegacy = getPublicEventDiagram;

// ----------------------------
// Login (legacy expectations vary)
// ----------------------------
// Supports both:
// - login("organizer", email, pw)
// - login(email, pw, "organizer")
...
// ----------------------------
// Organizer: Events (export name required by OrganizerEventsPage)
// ----------------------------
...
// Some older files used listOrganizerEvents
export const listOrganizerEvents = fetchOrganizerEvents;

// ----------------------------
// Organizer: Applications (matches OrganizerApplicationsPage token-style calls)
// organizerListEventApplications(eventId, limit, token)
// ----------------------------
...
// ----------------------------
// Organizer: Profile (this is what your screenshot is asking for)
// ----------------------------
...
export async function createOrganizerContact(payload: any, token?: string | null): Promise<any> {
  // Most likely route. If your backend uses a different one, we can add a tryPostFirst later.
  return apiPost<any>(`/organizer/contacts`, payload, token);
}

export async function fetchOrganizerContacts(token?: string | null): Promise<any> {
  return apiGet<any>(`/organizer/contacts`, token);
}

// ----------------------------
// Vendor diagram helper (some pages import this name)
// ----------------------------
