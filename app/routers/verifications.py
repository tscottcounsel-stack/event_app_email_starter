...
def _set_profile_state(row: Profile, data: Dict[str, Any]) -> None:
    ...
    explicit_verified = (
        ...
        or merged_verification_status in {"verified", "approved", "expiring_soon"}
        or merged_review_status in {"approved", "verified"}
    )
...
def _profile_public(row: Profile) -> Dict[str, Any]:
    ...
    explicit_verified = (
        ...
        or status_raw in {"verified", "approved", "expiring_soon"}
        or review_raw in {"approved", "verified"}
    )
