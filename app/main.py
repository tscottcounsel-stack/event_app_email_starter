...
app.add_middleware(
    ...
    allow_origin_regex=r"https://.*\.vendcore\.co|https://vendcore\.co|http://localhost:[0-9]+|http://127\.0\.0\.1:[0-9]+",
...
from app.models.verification_document import VerificationDocument, DocumentAccessGrant, DocumentAuditLog  # noqa: F401
